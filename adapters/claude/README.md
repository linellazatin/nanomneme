...
Requires Node.js 22.13+ (built-in `node:sqlite`). Claude Code installs this plugin through the nanomneme marketplace (`.claude-plugin/marketplace.json` at the repo root):
